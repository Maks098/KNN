...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        System.out.println("Podaj nazwe pliku, z którego mam pobrać zbiór treningowy(train-set.txt)");
        ...
        System.out.println("Podaj nazwe pliku, z ktorego mam pobrac zbior testowy(test-set.txt)");
